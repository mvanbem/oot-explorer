...
impl std::ops::Add<u32> for RomAddr {
    type Output = RomAddr;
    fn add(self, rhs: u32) -> RomAddr {
        RomAddr(self.0 + rhs)
    }
}
impl std::ops::AddAssign<u32> for RomAddr {
    fn add_assign(&mut self, rhs: u32) {
        self.0 += rhs;
    }
}
impl std::ops::Sub<RomAddr> for RomAddr {
    type Output = u32;
    fn sub(self, rhs: RomAddr) -> u32 {
        self.0 - rhs.0
    }
}
impl std::ops::Sub<u32> for RomAddr {
    type Output = RomAddr;
    fn sub(self, rhs: u32) -> RomAddr {
        RomAddr(self.0 - rhs)
    }
}
impl std::ops::SubAssign<u32> for RomAddr {
